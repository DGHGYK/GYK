...
public class OldTemplateFragment extends BaseFragment implements OnMenuItemClickListener, OnMenuItemLongClickListener {
    ...
    public OldTemplateFragment() {
    }

    public static OldTemplateFragment newInstance(Bundle args) {//bundle ile infodan gelen bilgileri almak için
        OldTemplateFragment fragment = new OldTemplateFragment();
    ...
    protected int getFID() {
        return R.layout.fragment_old_template;
    }
