...
import com.example.hatice.project.BusineesH.DatePickerFragment;
import com.example.hatice.project.R;
import com.example.hatice.project.BusineesH.TimePickerFragment;
        ...
        if (getIntent().getExtras().get("mood").equals("template")) {
            btn_bilgi_save.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    intent.putExtra("title", et_bilgi_title.getText().toString());
                    intent.putExtra("maintext", et_bilgi_maintext.getText().toString());
                    intent.putExtra("family1", et_bilgi_family1.getText().toString());
                    intent.putExtra("family2", et_bilgi_family2.getText().toString());
                    intent.putExtra("adress", et_bilgi_adress.getText().toString());
                    intent.putExtra("tag", et_bilgi_tag.getText().toString());
                    intent.putExtra("date", tv_bilgi_date.getText().toString());
                    intent.putExtra("time", tv_bilgi_time.getText().toString());
