...
import com.example.hatice.project.ActivityG.InviteeEditActivity;
...
public class InviteeListAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
        ...
        TextView inviteeId= (TextView) convertView
                .findViewById(R.id.tv_item_id);
        inviteeId.setText(listTitle.getId());
    ...
    public View getChildView(final int groupPosition, int childPosition, boolean isLastChild, View convertView, ViewGroup parent) {
        ...
        delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ContactListSingleton.getInst().getSelectedContactsList().removeContactById(in.getId());
                InviteeListSingleton.getInst().getInviteeList().remove(in);
